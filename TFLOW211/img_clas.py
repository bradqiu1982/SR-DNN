...
model_dir = './mydata/trained_model_imgcls/'
export_dir ='./mydata/exported_model_imgcls/'

train_data_input_path = './mydata/VCLAS_DATA/train_dataset.tfrecord'
valid_data_input_path = './mydata/VCLAS_DATA/valid_dataset.tfrecord'
