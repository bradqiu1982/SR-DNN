...
def maskrcnn_resnetfpn_coco_local() -> cfg.ExperimentConfig:
  ...
  config = cfg.ExperimentConfig(
      ...
      task=maskrcnn.MaskRCNNTask(
          ...
          model=maskrcnn.MaskRCNN(
              ...
              mask_head=maskrcnn.MaskHead(upsample_factor=4),
              num_classes=11, input_size=[HIGH, WIDTH, 3], include_mask=True),
          ...
          train_data=maskrcnn.DataConfig(
              ...
              parser=maskrcnn.Parser(
                  aug_rand_hflip=True, aug_scale_min=0.9, aug_scale_max=1.1)),
...
train_data_input_path = './mydata/ZURICHDATA/zurich_train-00000-of-00001.tfrecord'
valid_data_input_path = './mydata/ZURICHDATA/zurich_valid-00000-of-00001.tfrecord'
#test_data_input_path = './mydata/BCCD/test-00000-of-00001.tfrecord'
model_dir = './mydata/trained_model_mz/'
export_dir ='./mydata/exported_model_mz/'


#CONFIG PART
exp_config = maskrcnn_resnetfpn_coco_local()
batch_size = 8
num_classes = 10
...
#     params=exp_config,
#   checkpoint_path='./mydata/trained_model_mz/ckpt-2500', #tf.train.latest_checkpoint(model_dir),
