...
train_data_input_path = './mydata/XPADDATA/x_train_dataset.tfrecord'
valid_data_input_path = './mydata/XPADDATA/x_valid_dataset.tfrecord'
#test_data_input_path = './mydata/BCCD/test-00000-of-00001.tfrecord'
model_dir = './mydata/trained_model_x/'
export_dir ='./mydata/exported_model_x/'
...
exp_config.trainer.validation_steps =  3 # validation_steps = num_of_validation_examples // eval_batch_size
